...
This project is indexed by GitNexus as **GitNexus** (24339 symbols, 62316 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Scripts area (275 symbols) | `.claude/skills/generated/scripts/SKILL.md` |
| Work in the Lbug area (264 symbols) | `.claude/skills/generated/lbug/SKILL.md` |
| Work in the Unit area (239 symbols) | `.claude/skills/generated/unit/SKILL.md` |
| Work in the Kotlin area (210 symbols) | `.claude/skills/generated/kotlin/SKILL.md` |
| Work in the Tests area (194 symbols) | `.claude/skills/generated/tests/SKILL.md` |
| Work in the Cpp area (192 symbols) | `.claude/skills/generated/cpp/SKILL.md` |
| Work in the Ingestion area (182 symbols) | `.claude/skills/generated/ingestion/SKILL.md` |
| Work in the Storage area (163 symbols) | `.claude/skills/generated/storage/SKILL.md` |
| Work in the Integration area (162 symbols) | `.claude/skills/generated/integration/SKILL.md` |
| Work in the Cli area (156 symbols) | `.claude/skills/generated/cli/SKILL.md` |
| Work in the Group area (135 symbols) | `.claude/skills/generated/group/SKILL.md` |
| Work in the Passes area (125 symbols) | `.claude/skills/generated/passes/SKILL.md` |
| Work in the Local area (124 symbols) | `.claude/skills/generated/local/SKILL.md` |
| Work in the Type-extractors area (120 symbols) | `.claude/skills/generated/type-extractors/SKILL.md` |
| Work in the Cfg area (116 symbols) | `.claude/skills/generated/cfg/SKILL.md` |
| Work in the Workflow_bench area (112 symbols) | `.claude/skills/generated/workflow-bench/SKILL.md` |
| Work in the Embeddings area (108 symbols) | `.claude/skills/generated/embeddings/SKILL.md` |
| Work in the Workers area (89 symbols) | `.claude/skills/generated/workers/SKILL.md` |
| Work in the Extractors area (88 symbols) | `.claude/skills/generated/extractors/SKILL.md` |
