      ...
      {activePresets.map((preset) => {
        ...
        return (
          ...
          >
            ...
            <span className="font-body font-medium text-sm text-theme-primary">{preset.note}</span>
            <span className="font-body font-semibold text-sm text-theme-secondary tabular-nums ml-1">
