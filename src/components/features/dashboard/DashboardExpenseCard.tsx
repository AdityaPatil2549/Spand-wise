    ...
    <Tilt rotationFactor={6} isRevese>
      <div className="glass-panel rounded-2xl p-6 border border-[#d8d0c8]/30 hover-elevate flex flex-col justify-between h-48 relative overflow-hidden group">
        ...
        <div className="flex justify-between items-start relative z-20">
          <div className="p-3 bg-[#f2ece4] rounded-xl" style={{ color: iconColor }}>
            <span className="material-symbols-outlined">{icon}</span>
          </div>
          <span className="text-[12px] tracking-[0.1em] font-bold text-[#605850] uppercase">{timeLabel}</span>
        </div>
        <div className="relative z-20">
          <p className="text-[16px] text-[#605850] mb-1">{title}</p>
          <p className="font-display text-[24px] font-medium text-[#3a302a] flex items-center gap-[1px]">
