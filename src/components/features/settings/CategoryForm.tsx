...
export const CategoryForm = ({ editingCategory, onClose }: CategoryFormProps) => {
 ...
 <div className="bg-theme-base w-full max-w-md rounded-3xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
 <div className="flex items-center justify-between p-6 border-b border-theme-border/50 bg-theme-white">
 <h3 className="font-headline text-xl text-theme-primary">
 {editingCategory ? 'Edit Category' : 'New Category'}
 </h3>
 <button onClick={onClose} className="p-2 -mr-2 text-theme-tertiary hover:text-theme-primary rounded-full hover:bg-theme-elevated transition-colors">
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 selectedColor === color ? 'ring-2 ring-offset-2 ring-theme-accent scale-110' : 'hover:scale-110 shadow-sm'
 }`}
