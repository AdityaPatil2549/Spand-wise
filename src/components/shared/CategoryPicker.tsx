 ...
 */
export const CategoryPicker = ({ selectedId, onSelect, type = 'expense' }: CategoryPickerProps) => {
  const categories = useStore((s) => s.categories).filter((cat) => (cat.type || 'expense') === type);
