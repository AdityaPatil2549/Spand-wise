...
export const BudgetHeroCard = () => {
  ...
  return (
    <motion.div
      layout
      className="rounded-2xl p-6 text-white overflow-hidden relative mx-4 shadow-2xl"
      style={{ 
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none mix-blend-overlay">
        ...
        <div className="absolute -left-10 bottom-0 w-32 h-32 rounded-full bg-white blur-2xl" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-sm font-medium opacity-90 tracking-wide text-white/90">
