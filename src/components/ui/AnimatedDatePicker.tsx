    ...
    <>
      ...
      <div className="flex flex-col w-full">
        ...
        >
          ...
          <CalendarIcon className="w-5 h-5 text-[#c2652a]" />
        </button>
        ...
        <div className="flex flex-col items-center py-2">
          ...
          <div className="flex items-center justify-between w-full mb-6 px-2">
            <button
              ...
              className="p-3 rounded-full hover:bg-[#eae2da] transition-colors text-[#605850]"
            >
              <ChevronLeft className="w-6 h-6" />
            </button>
            <h3 className="text-xl font-bold text-[#3a302a] font-headline w-40 text-center">
          ...
          <div className="grid grid-cols-7 w-full mb-2">
            {['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'].map(day => (
              <div key={day} className="text-center text-xs font-bold text-[#78706a] uppercase tracking-wider">
                {day}
              </div>
            ))}
          </div>
                    ...
                    <div key={i} className="flex items-center justify-center h-10">
                      <button
                        ...
                        className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-200
                          ${isSelected 
                            ? 'bg-[#c2652a] text-white shadow-md scale-110' 
                            : isTodayDate
                              ? 'bg-[#eae2da] text-[#c2652a] border border-[#c2652a]/30'
                              : isCurrentMonth
                                ? 'text-[#3a302a] hover:bg-[#eae2da]'
                                : 'text-[#d8d0c8] hover:bg-[#eae2da]/50'
                          }`}
                      >
                        {format(day, 'd')}
                      </button>
