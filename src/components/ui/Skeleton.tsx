...
export const BudgetHeroSkeleton = () => (
 ...
 <Skeleton className="h-4 w-24 bg-theme-white/10" />
 <Skeleton className="h-12 w-48 bg-theme-white/20" />
 <Skeleton className="h-2 w-full bg-theme-white/10 rounded-full" />
 </div>
);
